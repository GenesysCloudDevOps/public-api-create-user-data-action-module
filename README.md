A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Create User
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-create-user-data-action-module.git?ref=main"
